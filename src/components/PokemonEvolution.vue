<template>
    <div class="pokemon-evolution col-12 col-md-12">
        <h2>Evolution</h2>
        <hr />
        <div class="row" v-if="pokemonEvolution.length > 0">
            <!-- eslint-disable-next-line -->
            <div
                class="col justify-content-center"
                v-for="(evolution, idx) in pokemonEvolution"
                :key="idx"
            >
                <div>
                ...
                <svg
                    ...
                    v-if="idx < pokemonEvolution.length - 1"
